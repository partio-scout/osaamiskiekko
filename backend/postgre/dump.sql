...
DROP INDEX IF EXISTS public.search_schools_logourl;
...
DROP INDEX IF EXISTS public.search_organizations_logourl;
...
436	application	nqf	find	f		3
437	application	nqf	findone	f		3
438	application	nqf	count	f		3
