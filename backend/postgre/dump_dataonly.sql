...
3	content-manager	contentmanager	findone	t		1
4	content-manager	contentmanager	create	t		1
5	content-manager	contentmanager	update	t		1
6	content-manager	contentmanager	updatesettings	t		1
7	content-manager	contentmanager	count	t		1
...
20	email	email	getsettings	t		1
21	email	email	updatesettings	t		1
22	settings-manager	settingsmanager	menu	t		1
23	settings-manager	settingsmanager	environments	t		1
24	settings-manager	settingsmanager	languages	t		1
25	settings-manager	settingsmanager	databases	t		1
26	settings-manager	settingsmanager	database	t		1
27	settings-manager	settingsmanager	databasemodel	t		1
...
87	content-type-builder	contenttypebuilder	createmodel	f		2
88	content-type-builder	contenttypebuilder	getconnections	f		2
89	content-type-builder	contenttypebuilder	deletemodel	f		2
90	content-type-builder	contenttypebuilder	updatemodel	f		2
...
125	users-permissions	auth	register	f		2
132	users-permissions	userspermissions	deleteprovider	f		2
...
120	users-permissions	auth	changepassword	f		2
...
136	users-permissions	userspermissions	getpolicies	f		2
...
121	users-permissions	auth	callback	f		2
130	users-permissions	user	create	f		2
...
123	users-permissions	auth	emailconfirmation	f		2
133	users-permissions	user	destroyall	f		2
...
137	users-permissions	userspermissions	getpermissions	f		2
...
124	users-permissions	auth	forgotpassword	f		2
...
129	users-permissions	user	update	f		2
...
244	application	organization	find	t		1
245	application	organization	findone	t		1
246	application	organization	count	t		1
247	application	organization	create	t		1
248	application	organization	destroy	t		1
249	application	organization	find	f		2
250	application	organization	findone	f		2
251	application	organization	count	f		2
252	application	organization	create	f		2
253	application	organization	update	t		1
254	application	organization	update	f		2
255	application	organization	destroy	f		2
256	application	organization	find	f		3
257	application	organization	findone	f		3
258	application	organization	count	f		3
259	application	organization	create	f		3
260	application	organization	update	f		3
261	application	organization	destroy	f		3
\.
...
1	partioadmin	partioadmin@test.com	local	$2a$10$fxss2F.MSuUBGKOft3T6Ke.4YUCp14gTra.Nq1rNwBtfbxYJWytra	\N	t	\N	1
\.
...
SELECT pg_catalog.setval('public."users-permissions_permission_id_seq"', 261, true);
