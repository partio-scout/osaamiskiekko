...
onMounted(() => {
  ...
  if (!apiStore.degreeMatch) {
    apiStore.getDegreeMatch(degreeId, skillId);
  }
});
</script>
...
<template>
  <v-container class="container" style="min-height: 100%" fluid>
    ...
    <v-row class="fill-height" style="max-width: 2000px; margin: 0 auto">
      <v-col cols="12">
        <!-- HEADER -->
        <Header :route-to="`/degrees/${route.params.degreeId}`" :text="tr('RETURN_BUTTON_3')" />
        <!-- WRAPPER -->
        <v-row justify="center">
          <v-col cols="11">
            <v-row>
              ...
              <!-- PLUS sign -->
              <v-col
                class="text-center pl-md-5 text-h4 text-sm-h2 pt-md-16 poppins-purple"
                cols="12"
                :sm="12"
                :md="1"
                :lg="1"
                ...
                <v-row dense>
                  ...
                  <v-col cols="12" :sm="12" :md="10" :lg="12" :xl="12" v-auto-animate>
                    ...
                    <SkillCardFull
                      ...
                      :selectedDegree="apiStore.degree"
                      :card="apiStore.skill"
                    />
                  </v-col>
                </v-row>
              ...
              <!-- EQUAL sign -->
              <v-col
                class="ma-0 pa-0 pl-md-5 text-center text-h4 text-sm-h2 pt-lg-16 poppins-purple"
                cols="12"
                :sm="12"
                :md="11"
                :lg="1"
              ...
              <v-col cols="12" :sm="12" :md="12" :lg="3" :xl="3">
                <v-row dense justify="center">
                  ...
                  <v-col cols="12" :sm="12" :md="8" :lg="12" :xl="12" v-auto-animate>
                    <!-- LOADING ICON -->
                    <v-col style="text-align: center" v-if="apiStore.isLoading.degreeMatch">
                      <v-progress-circular
                    ...
                    <ResultCard
                      class="mx-0 px-0"
                      v-if="apiStore.degreeMatch"
                      :card="apiStore.degreeMatch"
                    />
                  </v-col>
                </v-row>
              </v-col>
              ...
              <v-col class="pb-10" cols="12" style="color: rgb(var(--v-theme-h1))">
                <Thumbs :degreeId="degreeId" :skillId="skillId" :feedbackType="'degree'" />
              </v-col>
              <!-- FOOTER -->
              <Footer />
            </v-row>
