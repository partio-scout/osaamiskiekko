...
2	otayhteytta	Ota yhteyttä_en	Ota yhteyttä Jonka otsikko on tarkoituksella pitempi kuin normaalisti normaalisti normaalisti normaalisti normaalisti normaalisti normaalisti normaalisti normaalisti normaalisti normaalisti normaalisti normaalisti normaalisti	Ota yhteyttä_sv	Kaikissa Osaamiskiekkoon liittyvissä asioissa ole yhteydessä Partion osaamiskeskukseen. Tarkemmat yhteystiedot sivulla [http://osaamiskeskus.partio.fi/yhteystiedot/](http://osaamiskeskus.partio.fi/yhteystiedot/)._en\n\n	Kaikissa Osaamiskiekkoon liittyvissä asioissa ole yhteydessä Partion osaamiskeskukseen. Tarkemmat yhteystiedot sivulla [http://osaamiskeskus.partio.fi/yhteystiedot/](http://osaamiskeskus.partio.fi/yhteystiedot/).\n\n	Kaikissa Osaamiskiekkoon liittyvissä asioissa ole yhteydessä Partion osaamiskeskukseen. Tarkemmat yhteystiedot sivulla [http://osaamiskeskus.partio.fi/yhteystiedot/](http://osaamiskeskus.partio.fi/yhteystiedot/)._sv\n\n	2019-06-12 09:21:49.709+00	2019-06-13 06:38:24.878+00
1	tietoa	Information_en	Tietoa osaamiskiekosta	Information_sv	## Tietoa osaamiskiekosta\n\nOsaamiskiekko havainnollistaa, kuinka harrastus- ja vapaaehtoistoiminnassa kertyvää osaamista voi hyödyntää tutkintoon johtavissa opinnoissa. Osaamiskiekko näyttää validoitujen järjestökoulutusten ja digitaalisten osaamismerkkien sisältöjen vastaavuudet tutkinto-opintoihin. Sovelluksessa näytetään oppilaitosten suositukset siitä, miten järjestötoiminnassa hankittu osaaminen voidaan tunnistaa ja tunnustaa opinnoissa.\n\nOsaamiskiekon ensimmäisen version on kehittänyt Partion nuorisoalan osaamiskeskus Opetus-  ja kulttuuriministeriön rahoituksella.\n\n### Usein kysyttyä osaamiskiekosta\n\n#### Mistä osaamiskiekon sisältö on peräisin?\n\nOsaamiskiekko näyttää järjestöjen koulutusten ja digitaalisten osaamismerkkien kuvauksia sekä oppilaitostentutkintojen   kuvauksia. Keskeinen   osa   osaamiskiekkoa   on   oppilaitoksen   laatima   suositus   siitä,   miten   järjestöissä kertyvä osaaminen tunnustetaan kyseisessä oppilaitoksessa ja sen tutkinnoissa. Oppilaitokset ja järjestöt  tuottavat  itse  omat  sisältönsä  osaamiskiekkoon  ja  ne  päivitetään  osaamiskiekkoon  ylläpidon toimesta.\n\n#### Kuinka osaamiskiekkoon pääsee mukaan?\n\nOsaamiskiekon sisällöntuottajiksi ovat tervetulleita järjestöt ja oppilaitokset. Osaamiskiekkoon sisällytetään järjestöosaamista validoitujen koulutusten sekä digitaalisten osaamismerkkien muodossa. Jos järjestöllännetai oppilaitoksellanne on jo valmiiksi olemassa järjestöjen ja oppilaitosten välisiä AHOT-yhteistyösopimuksia, nämä ovat suoraan yhteensopivaa sisältöä osaamiskiekkoon.\n\n#### Mitä ovat tulkintafoorumit?\n\nOsaamiskiekon taustalla on moniammatillinen tulkintafoorumityöskentely. Tulkintafoorumeissa on mukana oppilaitoksen opettajia, opinto-ohjaajia ja opiskelijakunnan edustajia sekä järjestöistä koulutussuunnitelija ja muita järjestökoulutuksen parissa työskenteleviä henkilöitä. Tämä ryhmä vertailee tietyn tutkinnon opetussuunnitelman sisältöjä validoitujen järjestökoulutusten ja digitaalisten osaamismerkkien sisältöihin ja osaamistavoitteisiin. Työskentelyn tavoitteena on luoda suositus siitä, miten järjestön koulutus tai osaamismerkki tunnustetaan osaksi kyseistä tutkintoa.\n\n#### Mitä ovat validoidut koulutukset?\n\nJärjestöt  voivat  validoida  koulutuksiaan Opintokeskus  Siviksen  kautta.  Validoiduista  koulutuksista  saa  opintopisteytetyn todistuksen, jossa virallisena koulutuksenjärjestäjänä toimii Sivis.\n\n#### Mitä ovat NQF-tasot?\n\nOsaamiskiekossa hyödynnetään NQF-tasoja järjestöosaamisen   ja   tutkintojen   vertailuun.   NQF-tasolla (käytetään myös termiä EQF-taso) tarkoitetaan kansallista tutkintojen viitekehystä. Suomessa on käytössä 8-tasoinen   NQF-viitekehys,   jossa   esimerkiksi   toisen   asteen   tutkinnot   sijoittuvat   tasolle   4   ja   alemmat   ammattikorkeakoulututkinnot  tasolle  6.  Järjestökoulutuksille voidaan  osana  validointiprosessia määritellä, mitä NQF-tasoa ne vastaavat.\n\n#### Kuka ylläpitää osaamiskiekkoa?\n\nOsaamiskiekon ylläpidosta vastaa vuoden 2019 aikana Partion nuorisoalan osaamiskeskus.\n\n#### Minulla on palaute tai kehittämisehdotus osaamiskiekkoon liittyen. Mihin voin olla yhteydessä?\n\nOsaamiskiekkoon   liittyvissä   kysymyksissä   ja   kommenteissa   voi   olla   yhteydessä   Partion   nuorisoalan   osaamiskeskukseen._en	## Tietoa osaamiskiekosta\n\nOsaamiskiekko havainnollistaa, kuinka harrastus- ja vapaaehtoistoiminnassa kertyvää osaamista voi hyödyntää tutkintoon johtavissa opinnoissa. Osaamiskiekko näyttää validoitujen järjestökoulutusten ja digitaalisten osaamismerkkien sisältöjen vastaavuudet tutkinto-opintoihin. Sovelluksessa näytetään oppilaitosten suositukset siitä, miten järjestötoiminnassa hankittu osaaminen voidaan tunnistaa ja tunnustaa opinnoissa.\n\nOsaamiskiekon ensimmäisen version on kehittänyt Partion nuorisoalan osaamiskeskus Opetus-  ja kulttuuriministeriön rahoituksella.\n\n### Usein kysyttyä osaamiskiekosta\n\n#### Mistä osaamiskiekon sisältö on peräisin?\n\nOsaamiskiekko näyttää järjestöjen koulutusten ja digitaalisten osaamismerkkien kuvauksia sekä oppilaitostentutkintojen   kuvauksia. Keskeinen   osa   osaamiskiekkoa   on   oppilaitoksen   laatima   suositus   siitä,   miten   järjestöissä kertyvä osaaminen tunnustetaan kyseisessä oppilaitoksessa ja sen tutkinnoissa. Oppilaitokset ja järjestöt  tuottavat  itse  omat  sisältönsä  osaamiskiekkoon  ja  ne  päivitetään  osaamiskiekkoon  ylläpidon toimesta.\n\n#### Kuinka osaamiskiekkoon pääsee mukaan?\n\nOsaamiskiekon sisällöntuottajiksi ovat tervetulleita järjestöt ja oppilaitokset. Osaamiskiekkoon sisällytetään järjestöosaamista validoitujen koulutusten sekä digitaalisten osaamismerkkien muodossa. Jos järjestöllännetai oppilaitoksellanne on jo valmiiksi olemassa järjestöjen ja oppilaitosten välisiä AHOT-yhteistyösopimuksia, nämä ovat suoraan yhteensopivaa sisältöä osaamiskiekkoon.\n\n#### Mitä ovat tulkintafoorumit?\n\nOsaamiskiekon taustalla on moniammatillinen tulkintafoorumityöskentely. Tulkintafoorumeissa on mukana oppilaitoksen opettajia, opinto-ohjaajia ja opiskelijakunnan edustajia sekä järjestöistä koulutussuunnitelija ja muita järjestökoulutuksen parissa työskenteleviä henkilöitä. Tämä ryhmä vertailee tietyn tutkinnon opetussuunnitelman sisältöjä validoitujen järjestökoulutusten ja digitaalisten osaamismerkkien sisältöihin ja osaamistavoitteisiin. Työskentelyn tavoitteena on luoda suositus siitä, miten järjestön koulutus tai osaamismerkki tunnustetaan osaksi kyseistä tutkintoa.\n\n#### Mitä ovat validoidut koulutukset?\n\nJärjestöt  voivat  validoida  koulutuksiaan Opintokeskus  Siviksen  kautta.  Validoiduista  koulutuksista  saa  opintopisteytetyn todistuksen, jossa virallisena koulutuksenjärjestäjänä toimii Sivis.\n\n#### Mitä ovat NQF-tasot?\n\nOsaamiskiekossa hyödynnetään NQF-tasoja järjestöosaamisen   ja   tutkintojen   vertailuun.   NQF-tasolla (käytetään myös termiä EQF-taso) tarkoitetaan kansallista tutkintojen viitekehystä. Suomessa on käytössä 8-tasoinen   NQF-viitekehys,   jossa   esimerkiksi   toisen   asteen   tutkinnot   sijoittuvat   tasolle   4   ja   alemmat   ammattikorkeakoulututkinnot  tasolle  6.  Järjestökoulutuksille voidaan  osana  validointiprosessia määritellä, mitä NQF-tasoa ne vastaavat.\n\n#### Kuka ylläpitää osaamiskiekkoa?\n\nOsaamiskiekon ylläpidosta vastaa vuoden 2019 aikana Partion nuorisoalan osaamiskeskus.\n\n#### Minulla on palaute tai kehittämisehdotus osaamiskiekkoon liittyen. Mihin voin olla yhteydessä?\n\nOsaamiskiekkoon   liittyvissä   kysymyksissä   ja   kommenteissa   voi   olla   yhteydessä   Partion   nuorisoalan   osaamiskeskukseen.	## Tietoa osaamiskiekosta\n\nOsaamiskiekko havainnollistaa, kuinka harrastus- ja vapaaehtoistoiminnassa kertyvää osaamista voi hyödyntää tutkintoon johtavissa opinnoissa. Osaamiskiekko näyttää validoitujen järjestökoulutusten ja digitaalisten osaamismerkkien sisältöjen vastaavuudet tutkinto-opintoihin. Sovelluksessa näytetään oppilaitosten suositukset siitä, miten järjestötoiminnassa hankittu osaaminen voidaan tunnistaa ja tunnustaa opinnoissa.\n\nOsaamiskiekon ensimmäisen version on kehittänyt Partion nuorisoalan osaamiskeskus Opetus-  ja kulttuuriministeriön rahoituksella.\n\n### Usein kysyttyä osaamiskiekosta\n\n#### Mistä osaamiskiekon sisältö on peräisin?\n\nOsaamiskiekko näyttää järjestöjen koulutusten ja digitaalisten osaamismerkkien kuvauksia sekä oppilaitostentutkintojen   kuvauksia. Keskeinen   osa   osaamiskiekkoa   on   oppilaitoksen   laatima   suositus   siitä,   miten   järjestöissä kertyvä osaaminen tunnustetaan kyseisessä oppilaitoksessa ja sen tutkinnoissa. Oppilaitokset ja järjestöt  tuottavat  itse  omat  sisältönsä  osaamiskiekkoon  ja  ne  päivitetään  osaamiskiekkoon  ylläpidon toimesta.\n\n#### Kuinka osaamiskiekkoon pääsee mukaan?\n\nOsaamiskiekon sisällöntuottajiksi ovat tervetulleita järjestöt ja oppilaitokset. Osaamiskiekkoon sisällytetään järjestöosaamista validoitujen koulutusten sekä digitaalisten osaamismerkkien muodossa. Jos järjestöllännetai oppilaitoksellanne on jo valmiiksi olemassa järjestöjen ja oppilaitosten välisiä AHOT-yhteistyösopimuksia, nämä ovat suoraan yhteensopivaa sisältöä osaamiskiekkoon.\n\n#### Mitä ovat tulkintafoorumit?\n\nOsaamiskiekon taustalla on moniammatillinen tulkintafoorumityöskentely. Tulkintafoorumeissa on mukana oppilaitoksen opettajia, opinto-ohjaajia ja opiskelijakunnan edustajia sekä järjestöistä koulutussuunnitelija ja muita järjestökoulutuksen parissa työskenteleviä henkilöitä. Tämä ryhmä vertailee tietyn tutkinnon opetussuunnitelman sisältöjä validoitujen järjestökoulutusten ja digitaalisten osaamismerkkien sisältöihin ja osaamistavoitteisiin. Työskentelyn tavoitteena on luoda suositus siitä, miten järjestön koulutus tai osaamismerkki tunnustetaan osaksi kyseistä tutkintoa.\n\n#### Mitä ovat validoidut koulutukset?\n\nJärjestöt  voivat  validoida  koulutuksiaan Opintokeskus  Siviksen  kautta.  Validoiduista  koulutuksista  saa  opintopisteytetyn todistuksen, jossa virallisena koulutuksenjärjestäjänä toimii Sivis.\n\n#### Mitä ovat NQF-tasot?\n\nOsaamiskiekossa hyödynnetään NQF-tasoja järjestöosaamisen   ja   tutkintojen   vertailuun.   NQF-tasolla (käytetään myös termiä EQF-taso) tarkoitetaan kansallista tutkintojen viitekehystä. Suomessa on käytössä 8-tasoinen   NQF-viitekehys,   jossa   esimerkiksi   toisen   asteen   tutkinnot   sijoittuvat   tasolle   4   ja   alemmat   ammattikorkeakoulututkinnot  tasolle  6.  Järjestökoulutuksille voidaan  osana  validointiprosessia määritellä, mitä NQF-tasoa ne vastaavat.\n\n#### Kuka ylläpitää osaamiskiekkoa?\n\nOsaamiskiekon ylläpidosta vastaa vuoden 2019 aikana Partion nuorisoalan osaamiskeskus.\n\n#### Minulla on palaute tai kehittämisehdotus osaamiskiekkoon liittyen. Mihin voin olla yhteydessä?\n\nOsaamiskiekkoon   liittyvissä   kysymyksissä   ja   kommenteissa   voi   olla   yhteydessä   Partion   nuorisoalan   osaamiskeskukseen._sv	2019-06-12 09:19:45.712+00	2019-06-13 06:39:01.995+00
\.
...
237	application	academicdegree	count	t		2
...
236	application	academicdegree	findone	t		2
235	application	academicdegree	find	t		2
271	application	school	find	t		2
273	application	school	count	t		2
276	application	school	destroy	f		2
275	application	school	update	f		2
274	application	school	create	f		2
243	application	competence	count	t		2
245	application	competence	update	f		2
246	application	competence	destroy	f		2
241	application	competence	find	t		2
244	application	competence	create	f		2
255	application	fieldofstudy	count	t		2
254	application	fieldofstudy	findone	t		2
256	application	fieldofstudy	create	f		2
253	application	fieldofstudy	find	t		2
265	application	organization	find	t		2
266	application	organization	findone	t		2
251	application	competencedegreelink	update	f		2
264	application	nqf	destroy	f		2
263	application	nqf	update	f		2
261	application	nqf	count	t		2
...
371	application	competence	delete	f		1
370	application	academicdegree	delete	f		1
372	application	competencedegreelink	delete	f		1
373	application	fieldofstudy	delete	f		1
374	application	nqf	delete	f		1
375	application	organization	delete	f		1
376	application	page	delete	f		1
377	application	school	delete	f		1
...
378	application	academicdegree	delete	f		2
385	application	school	delete	f		2
358	application	page	findone	t		2
359	application	page	find	t		2
360	application	page	count	t		2
384	application	page	delete	f		2
362	application	page	update	f		2
363	application	page	destroy	f		2
361	application	page	create	f		2
379	application	competence	delete	f		2
381	application	fieldofstudy	delete	f		2
383	application	organization	delete	f		2
380	application	competencedegreelink	delete	f		2
382	application	nqf	delete	f		2
...
SELECT pg_catalog.setval('public."users-permissions_permission_id_seq"', 385, true);
