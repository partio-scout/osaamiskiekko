...
5	db_model_fieldofstudies	{"name_fi":{"type":"string","required":true},"name_en":{"type":"string","required":true},"name_sv":{"type":"string","required":true},"created_at":{"type":"timestamp"},"updated_at":{"type":"timestampUpdate"}}	object	\N	\N
...
3	db_model_schools	{"name_en":{"type":"string","required":true},"name_fi":{"type":"string","required":true},"name_sv":{"type":"string","required":true},"description_en":{"type":"text"},"description_fi":{"type":"text"},"description_sv":{"type":"text"},"url":{"type":"string"},"logo":{"model":"file","via":"related","plugin":"upload"},"logoUrl":{"type":"string"},"academicdegrees":{"collection":"academicdegree","via":"school","isVirtual":true},"created_at":{"type":"timestamp"},"updated_at":{"type":"timestampUpdate"}}	object	\N	\N
2	db_model_academicdegrees	{"identification":{"type":"string","required":true},"name_en":{"type":"string","required":true},"name_fi":{"type":"string","required":true},"name_sv":{"type":"string","required":true},"description_en":{"type":"text","required":true},"description_fi":{"type":"text","required":true},"description_sv":{"type":"text","required":true},"url":{"type":"string"},"credits":{"type":"integer"},"nqf":{"model":"nqf"},"school":{"model":"school","via":"academicdegrees"},"fieldofstudy":{"model":"fieldofstudy"},"competencedegreelinks":{"collection":"competencedegreelink","via":"academicdegree","isVirtual":true},"created_at":{"type":"timestamp"},"updated_at":{"type":"timestampUpdate"}}	object	\N	\N
...
1	The Guides and Scouts of Finland	Suomen Partiolaiset – Finlands Scouter ry	Suomen Partiolaiset – Finlands Scouter ry	Suomen Partiolaiset – Finlands Scouter ry on partioliikkeen keskusjärjestö Suomessa ja Suomen suurin nuorisojärjestö.	Suomen Partiolaiset – Finlands Scouter ry on partioliikkeen keskusjärjestö Suomessa ja Suomen suurin nuorisojärjestö._en	Suomen Partiolaiset – Finlands Scouter ry on partioliikkeen keskusjärjestö Suomessa ja Suomen suurin nuorisojärjestö._sv	https://www.partio.fi	\N	2019-05-09 09:55:05.648+00	2019-05-13 09:27:55.567+00
\.
